...
import com.scxd.lawqinghai.mvp.model.ElectronicMonitoringInputDetailModel;
import com.scxd.lawqinghai.mvp.model.ElectronicMonitoringInputDetailModelImp;
...
public class ElectronicMonitoringInputDetailPersenter extends BasePresenter<ElectronicMonitoringInputDetailView> {


    ElectronicMonitoringInputDetailModelImp mModel=new ElectronicMonitoringInputDetailModel();
    ...
    public void LoadDetail(String jdsbh) {
        ...
        mModel.queryDetail(jdsbh, new MVPCallBack() {
            ...
            public void succeed(Object bean) {
                mView.disDialog();
                if (bean != null) {
                    mView.backQueryDetail((ElectronicMonitoringInputDetailResBean) bean);
    ...
    public void comitData(Context context, ElectronicMonitoringInputDetailReqBan bean) {
...
//                mView.disDialog();
                if (bean != null) {
                    mView.backCommitPhotos((String) bean);
...
//                mView.disDialog();
    ...
    public void commitBackPhotos(Context context, String url, String user, String yjxh, String zpzl, List<String> 
            object){
        //        if (mView != null) {
        //            mView.showLoadProgressDialog("正在提交照片...");
        //        }
