package com.scxd.lawqinghai.widget.dialog;
...
public class BaseDialog extends Dialog implements View.OnClickListener {
    ...
    public static BaseDialog getDialog(Context context, int titleId, int message, int button1,OnClickListener listener1) {
    ...
    public static BaseDialog getDialog(Context context, int titleId, int message, int button1,OnClickListener listener1, int button2, OnClickListener listener2) {
        return getDialog(context, titleId, context.getResources().getString(message), context.getResources()
                .getString(button1), listener1, context.getResources().getString(button2), listener2, null, null);
    }

    public static BaseDialog getDialog(Context context, int titleId, String message, int button1,OnClickListener listener1, int button2, OnClickListener listener2) {
    ...
    public boolean buttonIsExist(CharSequence button1, OnClickListener listener1, CharSequence
            button2, OnClickListener listener2, CharSequence button3, OnClickListener
            listener3) {
