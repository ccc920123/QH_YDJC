...
public class NotificationOfCompulsoryMeasuresDetailResBean {
    ...
    private List<NotificationOfCompulsoryMeasuresListResBean> wfxwlist;
    private String zqmj;
    private String fxjg;
    private String qzcs;
    ...
    public List<NotificationOfCompulsoryMeasuresListResBean> getWfxwlist() {
        return wfxwlist;
    }

    public void setWfxwlist(List<NotificationOfCompulsoryMeasuresListResBean> wfxwlist) {
