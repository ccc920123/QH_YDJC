...
import com.scxd.lawqinghai.nfcexputils.Ntag_Get_Version.Prod;
import com.scxd.lawqinghai.nfcexputils.Ntag_I2C_Commands.Register;
...
public class NFC_Enabled_Commands {
	...
	public byte[] getSessionRegisters() throws IOException, FormatException {
		...
		byte[] temp = reader.read(Register.Session.getValue());
