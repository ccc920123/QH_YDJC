...
import com.parkingwang.vehiclekeyboard.utils.Devcode;
import com.parkingwang.vehiclekeyboard.utils.FrameCapture;
import com.parkingwang.vehiclekeyboard.utils.Utils;
import com.parkingwang.vehiclekeyboard.view.PlateViewfinderView;
...
public class ScenCameraActivity extends AppCompatActivity implements
 ...
 private static final String PATH = Environment
            .getExternalStorageDirectory().toString() + "/LawQingHai/Camera/";
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 5) {
                ...
                if (rotation == 90 || rotation == 270) {
                    myview = new PlateViewfinderView(ScenCameraActivity.this, false, preWidth, preHeight);
                } else {
                    myview = new PlateViewfinderView(ScenCameraActivity.this, true, preWidth, preHeight);
                }
                re.addView(myview);
                if (camera != null) {
...
//		System.out.println("左  ："+prp.plateIDCfg.left+"   右  ："+prp.plateIDCfg.right+"     高："+prp.plateIDCfg.top+"    底："+prp.plateIDCfg.bottom);
    ...
    private void initCamera(SurfaceHolder holder, int setPreWidth, int setPreHeight) {
        ...
        camera.setPreviewCallback(ScenCameraActivity.this);
        camera.startPreview();
