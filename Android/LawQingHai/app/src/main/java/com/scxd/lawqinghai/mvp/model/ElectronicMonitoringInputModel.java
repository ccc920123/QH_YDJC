...
import com.scxd.lawqinghai.bean.response.BaseElectronicMonitoringInputJson;
...
public class ElectronicMonitoringInputModel implements ElectronicMonitoringInputModelImp {
     ...
     */
    @Override
    public void backElectronicMonitoringInput(String user, String bmbh, String starTime, String endTime, int page, final MVPCallBack mvpCallBack) {

        ElectronicMonitoringInputReqBean object = new ElectronicMonitoringInputReqBean(user, bmbh,
                starTime, endTime, page, 10);


        NetWorking.requstJsonNetData("Q19", Common.QUERY, object, new DataCallback() {
            @Override
            ...
            public void onResponse(String response, int id) {
                ...
                if (Common.isDataTest) {
                    ...
                    ElectronicMonitoringInputResBean jsonObj = JSON.parseObject(response, ElectronicMonitoringInputResBean.class);
                ...
                if (jsonObj.getMeta().isSuccess()) {
                    ...
                    LogUtil.open().appendMethodB("返回Q19Exception:" + e.getMessage() + "--" + e.toString() + "\n");
