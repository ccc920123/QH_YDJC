...
import com.stardon.lib.videolib.activity.fragment.VideoPreviewFragment;

import java.util.Formatter;
import java.util.Locale;

/**
 * 类名: UniversalMediaController
 * <br/>功能描述: 视频播放进度条(控制中心)，
 * <br/>作者: 陈渝金
 * <br/>时间: 2016/11/16
 * <br/>最后修改者:
 * <br/>最后修改内容:
...
public class UniversalMediaController extends FrameLayout {
    ...
    private static View mBackButton;// 返回按钮
    /**
     * 加载
     */
     ...
     * 视频返回
     */
    private static TextView voidProBack;
    /**
     * 重录
     */
    private static TextView mTextViewRetake;
    /**
     * 完成
     */
    private static TextView mTextViewFinish;

    /**
     * 方法名称: UniversalMediaController
     * <br/>方法详述:  控件入口
     * <br/>参数: context,attrs
     * <br/>返回值:
     * <br/>异常抛出 Exception:
    ...
    private void initControllerView(View v) {
        ...
        voidProBack= (TextView) v.findViewById(R.id.voidproback);
        mTextViewRetake= (TextView) v.findViewById(R.id.retake);
        mTextViewFinish= (TextView) v.findViewById(R.id.finish);
        if (mTurnButton != null) {
    ...
    /**方法名称: getVideoBackTextView
     * <br/>方法详述: 得到预览录像界面的返回按钮（右带有“返回”字样）
     * <br/>参数:
     * <br/>返回值:
     * <br/>异常抛出 Exception:
     * <br/>异常抛出 NullPointerException:
    ...
    public  static  TextView getVideoBackTextView()
    {
        return  voidProBack;
    }
    /**方法名称: getVideoBackTextView
     * <br/>方法详述: 得到预览录像界面的返回按钮（左）
     * <br/>参数:
     * <br/>返回值:
     * <br/>异常抛出 Exception:
     * <br/>异常抛出 NullPointerException:
    ...
    public  static  View getVideoLeftBackTextView()
    {
        return  mBackButton;
    }

    /**方法名称: getVideoRetakeTextView
     * <br/>方法详述: 得到预览录像界面的重录按钮
     * <br/>参数:
     * <br/>返回值:
     * <br/>异常抛出 Exception:
     * <br/>异常抛出 NullPointerException:
    ...
    public  static  TextView getVideoRetakeTextView()
    {
        return  mTextViewRetake;
    }
    /**方法名称: getVideoFinishTextView
     * <br/>方法详述: 得到预览录像界面的成功按钮
     * <br/>参数:
     * <br/>返回值:
     * <br/>异常抛出 Exception:
     * <br/>异常抛出 NullPointerException:
    ...
    public  static  TextView getVideoFinishTextView()
    {
        return  mTextViewFinish;
    }
