...
public class SummaryPunishmentDetailPersenter extends BasePresenter<SummaryPunishmentDetailView> {


    SummaryPunishmentDetailModelImp mModel = new SummaryPunishmentDetailModel();
    ...
    public void comitData(Context context, SummaryPunishmentDetailReqBan bean) {
     ...
     * @param context
     */
    public void comitCarLawData(Context context, CarPrintBean bean){
