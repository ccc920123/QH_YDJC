package com.scxd.lawqinghai.event;
...
import static com.scxd.lawqinghai.application.MyApplication.getApplication;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (mDefaultHandler != null) {
            ...
            NotificationService.startService(mContext, true);
